...
use Spryker\Glue\GlueApplication\Plugin\GlueApplication\Backend\BackendAbstractResourcePlugin;
...
class BackendAbstractResourcePluginTest extends Unit
{
    ...
    public function testGetResourceReturnsCallableResourceIfEmptyGlueResourceMethodConfigurationTransferExists(): void
    {
        ...
        $abstractResourcePluginMock = $this->getMockBuilder(BackendAbstractResourcePlugin::class)
            ->setMethods(['getDeclaredMethods', 'getController', 'getName'])
            ->getMock();
